...
{
	public class CreateSampleCustomerRequest
	{
		public CreateSampleCustomerRequest()
		{
		}

		public CreateSampleCustomerRequest(string code, string name)
		{
			Code = code;
			Name = name;
		}
		...
		public class MappingProfile : Profile
		{
			...
			{
				CreateMap<CreateSampleCustomerRequest, CreateSampleCustomerCommand>();
			}
		}
	}
}
