...
namespace Sai.DealAssistant.Application.Tests.SampleCustomers.Commands
{
	public class GetSampleCustomersForAccounting_Query_Test : UnitTestBase
	{
		private ReadRepository<SampleCustomer> _customerRepositary;

		public GetSampleCustomersForAccounting_Query_Test()
